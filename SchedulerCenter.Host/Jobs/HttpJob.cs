    ...
    public class HttpJob : IJob
    {
        ...
        public  async  Task Execute(IJobExecutionContext context)
        {
            ...
            try
            {
                ...
                string httpAddr = context.JobDetail.JobDataMap.GetString(Constant.HttpJobDetailKey.ApiUrl),
                       reqType= context.JobDetail.JobDataMap.GetString(Constant.HttpJobDetailKey.ApiMethod),
                       apiAuthKey = context.JobDetail.JobDataMap.GetString(Constant.HttpJobDetailKey.ApiAuthKey),
                       apiAuthValue= context.JobDetail.JobDataMap.GetString(Constant.HttpJobDetailKey.ApiAuthValue);
               ...
               var resStr = await res.Content.ReadAsStringAsync();
                await _jobService.Logger(new Options.LoggerOPT() { 
