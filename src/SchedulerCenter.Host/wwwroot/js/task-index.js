    ...
    data: {
        ...
        taskForm: [
            ...
            { name: 'authValue', text: 'header(value)', value: '', placeholder: '请求header验证的Key' },
            {
                ...
                }, placeholder: 'post/get/put/delete', type: 'select'
            },
            ...
            },
            {
                ...
                render: (h, params) => {
                    ...
                    switch (params.row.requestType) {
                        case 'get':
                            style.background = 'rgba(19, 206, 102, 0.8)';
                            text = 'GET';
                            break;
                        case 'post':
                            style.background = 'rgba(255, 120, 0, 1)';
                            text = 'POST';
                            break;
                        case 'put':
                            ...
                            break;
                        case 'delete':
                            style.background = 'rgba(255, 0, 8, 1)';
                            text = 'DELETE';
                            break;
                        case 'patch':
                            style.background = 'rgba(199, 21, 190, 1)';
                            text = 'PATCH';
                            break;
                        default:
                            style.background = '#f90';
